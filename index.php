...
<body>
    ...
    <div class="follow-header">
        ...
        <div class="text-follow-header">
            <h1>Controle, veja e simplifique sua vida aqui</h1>
            <p><br>Bem-vindo ao nosso site! Aqui você encontrará uma introdução completa sobre a bolsa de valores, um
                mercado financeiro dinâmico e repleto de oportunidades. </p>
            <br>
